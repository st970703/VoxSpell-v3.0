...
public class SpellingAid extends JFrame implements ActionListener{
	...
	public void levelCompleted() {
		...
		while (true) {
			int n = JOptionPane.showOptionDialog(this, "Please select an option:", "Congratulations!", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
